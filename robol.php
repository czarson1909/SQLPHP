...
<?php
    ...
    $query = "SELECT marka, model FROM modele WHERE marka='$marka' AND model='$model';";
     ...
     //echo    '<script>window.location = "robol.php";</script>';
     if(mysqli_num_rows($array) != 0){

     while ($row = mysqli_fetch_array  ($array))
         echo    '<script>
     alert("Pojazd dostępny!");
     window.location = "robol.php";
         </script>';
                        }else{
          echo    '<script>
...
<div id="lista2"><a href="main.php?w=2">Wyloguj</a></div>
    ...
    <div id="ramka1">
<p>Wyszukaj auto</p>
<form action="robol.php?w=1" method="post"> 
...
<div id="ramka2">
<p>Nowy klient</p>
<form action="robol.php?w=2" method="post"> 
...
<div id="ramka3">
<p>Usuń klienta</p>
<form action="robol.php?w=3" method="post"> 
            <label for="imie">Imię: </label>
            <input type="text" value="" name="imie" maxlength="25"> <br> 
            <label for="nazwisko">Nazwisko: </label>
            <input type="text" value="" name="nazwisko" maxlength="25"> <br>
